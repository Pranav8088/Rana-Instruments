...
import rightAngleBoreGaugeImg from '@/media/rana instruments/right angle bore gauge.png';
import ninetyDegreeBoreGaugeImg from '@/media/rana instruments/90° bore gauge .png';
import oneEightyDegreeBoreGaugeImg from '@/media/rana instruments/180° Bore gauge .png';
import flatBoreGaugeImg from '@/media/rana instruments/flat bore gauge .png';
import maxDepthBoreGaugeImg from '@/media/rana instruments/bore gauge with maximum depth.png';
import pitchCheckingBoreGaugeImg from '@/media/rana instruments/pitch checking gauge .png';
import boreGauge8001000Img from '@/media/rana instruments/800-1000mm bore gauge .png';
import boreGauge300900Img from '@/media/rana instruments/300-900mm bore gauge .png';
import leverTypeBoreGaugeImg from '@/media/rana instruments/Liver type borgauge.png';
import twoPointBoreGaugeImg from '@/media/rana instruments/2 point bore gauge.png';
import cTypeGrooveGaugeImg from '@/media/rana instruments/C type groove chekcing gauge.png';
import grooveDiameterGaugeImg from '@/media/rana instruments/groove diameter checking gauge.png';
import idCheckingGaugeImg from '@/media/rana instruments/ID checking gauge.png';
import smallGrooveCheckingGaugeImg from '@/media/rana instruments/small groove checking gauge.png';
import grooveWidthCheckingGaugeImg from '@/media/rana instruments/groove width checking gauge.png';
import grooveCheckingBallVerniersImg from '@/media/rana instruments/dial boll vernier.png';
import ballFitmentVerniersImg from '@/media/rana instruments/boll fitments.png';
import extraLongJawVernierImg from '@/media/rana instruments/extra jaw  length vernier.png';
import customDigitalVernierImg from '@/media/rana instruments/digital boll vernier.png';
import precisionBallProbesImg from '@/media/rana instruments/probe3.png';
import carbideBallProbe20mmImg from '@/media/rana instruments/probe 4.png';
import faroMachineProbeImg from '@/media/rana instruments/faro probe.png';
import pcdCheckingGaugeImg from '@/media/rana instruments/pcd checking gauge.png';
import valveHoleGaugeImg from '@/media/rana instruments/valve hole position checking gauge.png';
import phHoleCheckingGaugeImg from '@/media/rana instruments/ph hole position checking gauge.png';
import runoutCheckingFixtureImg from '@/media/rana instruments/runout checking gauge.png';
import flangeMicrometer300325Img from '@/media/rana instruments/flange fitment 300-325mm.png';
import flangeMicrometer400600Img from '@/media/rana instruments/flage micrometer 400-600mm.png';
import dialDepthGaugeImg from '@/media/rana instruments/dial deapth checking gauge.png';
import rtjGrooveMastersImg from '@/media/rana instruments/RTJ GROOVE MASTER.png';
import boreGaugeSettingMastersImg from '@/media/rana instruments/bore gauge setting master.png';
...
const products: Product[] = [
  ...
  },
  {
    ...
    category: 'Bore Gauges',
    image: ninetyDegreeBoreGaugeImg,
    aiHint: 'angle gauge',
  ...
  },
  {
    ...
    category: 'Bore Gauges',
    image: oneEightyDegreeBoreGaugeImg,
  ...
  },
  {
    ...
    category: 'Bore Gauges',
    image: pitchCheckingBoreGaugeImg,
    aiHint: 'pitch gauge',
  ...
  },
  {
    ...
    category: 'Groove Checking Gauges',
    image: smallGrooveCheckingGaugeImg,
    aiHint: 'small gauge',
  ...
  },
  {
    ...
    category: 'Groove Checking Gauges',
    image: grooveWidthCheckingGaugeImg,
    aiHint: 'width gauge',
  ...
  // =======================================================================
  {
    ...
    category: 'Verniers',
    image: grooveCheckingBallVerniersImg,
    aiHint: 'ball vernier',
  ...
  },
  {
    ...
    category: 'Custom Instruments',
    image: runoutCheckingFixtureImg,
  ...
  },
  {
    ...
    category: 'Custom Instruments',
    image: flangeMicrometer300325Img,
    aiHint: 'micrometer',
  ...
  },
  {
    ...
    category: 'Custom Instruments',
    image: flangeMicrometer400600Img,
  ...
  },
  {
    ...
    category: 'Custom Instruments',
    image: boreGaugeSettingMastersImg,
    aiHint: 'setting ring',
