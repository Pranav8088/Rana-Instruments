        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="lg:col-span-1">
            <Link href="/" className="inline-block mb-4 group">
              <Logo className="h-12 w-auto text-foreground group-hover:text-primary transition-colors" />
            </Link>
          ...
          <div>
            <h3 className="text-lg font-semibold text-foreground mb-4 font-headline">Products</h3>
          ...
          <div>
            <h3 className="text-lg font-semibold text-foreground mb-4 font-headline">Company</h3>
            <ul className="space-y-2 text-sm">
          ...
          <div>
            <h3 className="text-lg font-semibold text-foreground mb-4 font-headline">Contact Info</h3>
            <address className="not-italic space-y-2 text-sm text-muted-foreground">
              <p className="flex items-start">
                <MapPin className="w-5 h-5 mr-2 mt-0.5 text-primary shrink-0" />
