  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
      ...
      <div className="relative w-full h-64 md:h-80 mb-12 rounded-xl overflow-hidden shadow-xl">
        <Image
          src="/images/banners/customers.png"
          alt="Industries served by Rana Instruments"
          fill
        ...
        <div className="absolute bottom-6 left-6 md:bottom-10 md:left-10 text-white">
          <h3 className="text-2xl md:text-3xl font-bold font-headline">Powering Global Industries</h3>
        </div>
      </div>
          ...
          {industriesServed.map((industry) => (
            <Card key={industry.name} className="text-center hover:shadow-lg transition-shadow duration-300 rounded-lg flex flex-col">
              <CardHeader className="items-center">
                ...
                <CardTitle className="font-headline text-xl text-black">{industry.name}</CardTitle>
              </CardHeader>
